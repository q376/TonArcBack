...
class TournamentCreateRequest(BaseModel):
    ...
    start_timestamp: int  # Absolute Unix timestamp from client
...
def admin_create_tournament(
    ...
    # Use the timestamp provided by client (already in your timezone, converted to Unix)
...
def update_tournament_statuses(_: bool = Depends(verify_admin)):
    ...
    # Check upcoming tournaments - should they start?
    ...
    # Check active tournaments - should they end?
